...
def Walk():
    ...
    mySprite.set_position(25, 101)
    pause(2000)
    mySprite.set_position(50, 101)
    pause(2000)
    mySprite.set_position(75, 101)
    pause(2000)
    mySprite.set_position(100, 101)
    pause(2000)
    mySprite.set_position(125, 101)
    pause(2000)
    mySprite.set_position(150, 101)
    mySprite.destroy()
# This function makes you choose between  your first two items in the stre.
def First_choice():
    global Apple, Pizza, mySprite
    ...
    if game.ask("Apple?"):
        ...
        mySprite = sprites.create(img("""
            ...
            """),
            SpriteKind.player)
        mySprite.set_position(81, 101)
        pause(500)
        Apple.destroy()
        mySprite.set_position(114, 101)
        pause(500)
        mySprite.set_position(144, 101)
        mySprite.destroy()
    else:
